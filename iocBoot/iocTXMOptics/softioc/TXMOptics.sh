...
# Manually set IOC_STARTUP_DIR if 32idcSP1.sh will reside somewhere other than softioc
#!IOC_STARTUP_DIR=/home/username/epics/ioc/synApps/32idcSP1/iocBoot/ioc32idcSP1/softioc

# Manually set IOC_COMMAND_DIR if 32idcSP1.sh will reside somewhere other than softioc
#!IOC_COMMAND_DIR=/home/username/epics/ioc/synApps/32idcSP1/iocBoot/ioc32idcSP1/softioc/commands
...
checkpid() {
    MY_UID=`${ID} -u`
    # The '\$' is needed in the pgrep pattern to select 32idcSP1, but not 32idcSP1.sh
